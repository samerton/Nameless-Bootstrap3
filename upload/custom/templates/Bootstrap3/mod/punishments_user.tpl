        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h2 style="margin-top:5px;display:inline;">{$PUNISHMENTS}</h2>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    {if $punishment.type_numeric == 1}
                                        <span class="label label-danger">{$punishment.type}</span>
                                    {elseif $punishment.type_numeric == 2}
                                        <span class="label label-warning">{$punishment.type}</span>
