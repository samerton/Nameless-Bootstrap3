			  ...
			  <tr>
				...
				<td>
				  ...
				  <div class="row">
				    <div class="col-md-3">
					  <div class="frame">
					    <a href="{$subforum.latest_post.last_user_link}"><img class="img-centre img-rounded" style="height:40px; width:40px;" src="{$subforum.latest_post.last_user_avatar}" alt="{$subforum.latest_post.last_user}" /></a>
					  </div>
				    </div>
				    <div class="col-md-9">
			...
			<tr>
			  ...
			  <td>
				<div class="row">
				  <div class="col-md-3">
					<div class="frame">
					  <a href="{$sticky.last_reply_link}"><img class="img-centre img-rounded" style="height:40px; width:40px;" src="{$sticky.last_reply_avatar}" alt="{$sticky.last_reply_username}" /></a>
					</div>
				  </div>
				  <div class="col-md-9">
			...
			<tr>
			  ...
			  <td>
				<div class="row">
				  <div class="col-md-3">
					<div class="frame">
					  <a href="{$discussion.last_reply_link}"><img class="img-centre img-rounded" style="height:40px; width:40px;" src="{$discussion.last_reply_avatar}" alt="{$discussion.last_reply_username}" /></a>
					</div>
				  </div>
				  <div class="col-md-9">
