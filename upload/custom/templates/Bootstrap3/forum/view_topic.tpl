			...
			<div class="row">
			  ...
			  <div class="col-md-9">
				...
				<span class="pull-right">
				  ...
				  <a class="btn btn-primary btn-sm" data-toggle="tooltip" data-trigger="hover" data-original-title="{$reply.buttons.edit.TEXT}" href="{$reply.buttons.edit.URL}"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></a>
				  {/if}
