        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h2 style="margin-top:5px;display:inline;">{$VIEWING_RESOURCES_BY}</h2>
                        ...
                        <table class="table table-striped">
                            ...
                            {foreach from=$LATEST_RESOURCES item=resource}
                                <tr>
                                    ...
                                    <td>
                                        <a href="{$resource.author_profile}"><img class="img-rounded" style="max-height:30px; max-width:30px;" src="{$resource.author_avatar}" alt="{$resource.author}" /></a><br />
