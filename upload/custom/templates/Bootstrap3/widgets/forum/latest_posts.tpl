<div class="panel panel-default">
    <div class="panel-body">
        <h3 style="margin-top:5px;">{$LATEST_POSTS}</h3>
        {foreach from=$LATEST_POSTS_ARRAY item=post name=latest_posts}
            <div class="row">
                <div class="col-md-3">
                    <div class="frame">
                        <a href="{$post.last_reply_profile_link}"><img class="img-centre img-rounded" style="max-height:30px;max-width:30px;" src="{$post.last_reply_avatar}" alt="{$post.last_reply_username}"/></a>
                    </div>
                </div>
                <div class="col-md-9">
